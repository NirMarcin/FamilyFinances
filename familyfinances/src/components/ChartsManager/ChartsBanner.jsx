...
export default function ChartsNav() {
  return (
    <div className="max-w-4xl mx-auto p-6 bg-white rounded-lg shadow-lg mt-8 mb-8">
      ...
      <p className="text-center text-orange-900 text-lg bg-orange-50 border border-orange-300 rounded-md px-6 py-4 shadow-inner">
        Analizuj swoje wydatki i przychody w formie wykresów
      </p>
    </div>
  );
}