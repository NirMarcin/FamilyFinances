...
export default function IncomeChartsSummary() {
  ...
  return (
    <div className="max-w-5xl mx-auto bg-white dark:bg-gray-900 rounded-xl shadow-lg p-6 mb-10 border border-orange-200 dark:border-gray-800 transition-colors duration-300">
      ...
      />
      <h3 className="text-2xl font-bold text-green-700 dark:text-orange-400 mb-6 text-center">
      ...
      <div className="flex flex-col md:flex-row gap-6 mb-8 justify-center">
        <div className="flex flex-col">
          ...
          <input
            ...
            className="border border-green-300 dark:border-gray-700 rounded px-2 py-1 w-full focus:outline-none focus:ring-2 focus:ring-green-200 dark:focus:ring-orange-400 bg-white dark:bg-gray-900 text-gray-900 dark:text-orange-300 transition-colors duration-300"
          />
        </div>
        <div className="flex flex-col">
          <label className="block text-sm font-semibold text-gray-700 dark:text-orange-300 mb-1">
      ...
      <div className="text-lg font-semibold mb-8 text-center dark:text-orange-400">
        Całkowita kwota:{" "}
        <span className="text-green-700 dark:text-orange-700">
              ...
              {allCategories.map((cat) => (
                <li
                  ...
                  className={`flex items-center justify-between cursor-pointer mb-1 px-2 py-1 rounded transition ${
                    selectedCategories.includes(cat)
                      ? "bg-green-100 dark:bg-gray-800 text-green-700 dark:text-orange-400 font-bold"
                ...
                >
                  ...
                  {amountByCategory[cat] !== undefined && (
                    <span className="text-green-700 dark:text-orange-400 font-medium">
